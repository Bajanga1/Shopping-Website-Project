                ...
                {loading ? <Loader /> : error ? <Message variant='danger'>{error}</Message> : (
                    <Form onSubmit={submitHandler}>
                        ...
                        <Form.Group controlId='image'>
                            ...
                            <Form.Control type='text' placeholder='Enter image' value={image} onChange={(event) => setImage(event.target.value)}></Form.Control>
                        ...
                        <Form.Group controlId='countinstock'>
                            ...
                            <Form.Control type='number' placeholder='Enter stock' value={countInStock} onChange={(event) => setCountInStock(event.target.value)}></Form.Control>
                        </Form.Group>
